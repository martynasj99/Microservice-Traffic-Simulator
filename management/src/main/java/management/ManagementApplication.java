...
public class ManagementApplication {
    ...
    CommandLineRunner initial(@Autowired ConfigurationService configurationService) {
        return args -> {
            ...
            configurationService.sendConfiguration("/work.json", "http://localhost:8085/setup");
            configurationService.sendConfiguration("/drivers.json", "http://localhost:9001/main/setup", "PUT");
        };
    }
